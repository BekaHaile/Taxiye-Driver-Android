...
public class JSONParser implements Constants {
	...
	public UserData parseUserData(Context context, JSONObject userData) throws Exception {
		...
		Prefs.with(context).save(Constants.FREE_STATE_UPDATE_TIME_PERIOD, userData.optLong("driver_free_state_update_time_period", 120000));
		Prefs.with(context).save(Constants.ACCEPTED_STATE_UPDATE_TIME_PERIOD, userData.optLong("driver_accepted_state_update_time_period", 15000));
