...
public class JSONParser implements Constants {
	...
	public UserData parseUserData(Context context, JSONObject userData) throws Exception {
		...
		Double minDriverBalance = null, actualWalletBalance = null;
		...
		if (userData.has("actual_credit_balance")) {
			actualWalletBalance = userData.getDouble("actual_credit_balance");
		}
...
//		Prefs.with(context).save(Constants.SHOW_AGREEMENT_SCREEN, userData.optInt("agreement_status", 1));
		...
		return new UserData(accessToken, userData.getString("user_name"),
				...
				referralImageD2D, referralImageD2C, getCreditsInfo, getCreditsImage, sendCreditsEnabled,vehicleMake,serviceDetailList, resendEmailInvoiceEnabled, minDriverBalance, actualWalletBalance);
	}
