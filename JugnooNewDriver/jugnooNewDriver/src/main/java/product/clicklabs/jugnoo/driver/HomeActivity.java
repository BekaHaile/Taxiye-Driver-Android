...
//        Log.e("Locale info", "="+localeInfo);
        ...
        driverNewRideRequestText.setTypeface(Data.latoRegular(getApplicationContext()));
        driverNewRideRequestClickText = (TextView) findViewById(R.id.driverNewRideRequestClickText);
        driverNewRideRequestClickText.setTypeface(Data.latoRegular(getApplicationContext()));
        ...
        driverIRDistanceValue.setTypeface(Data.latoRegular(getApplicationContext()));
        driverIRDistanceKmText = (TextView) findViewById(R.id.driverIRDistanceKmText);
        driverIRDistanceKmText.setTypeface(Data.latoRegular(getApplicationContext()));
        ...
        driverIRFareRsText = (TextView) findViewById(R.id.driverIRFareRsText);
        driverIRFareRsText.setTypeface(Data.latoRegular(getApplicationContext()));
        driverIRFareValue = (TextView) findViewById(R.id.driverIRFareValue);
        driverIRFareValue.setTypeface(Data.latoRegular(getApplicationContext()));
        ...
        waitChronometer.setTypeface(Data.latoRegular(getApplicationContext()), Typeface.BOLD);
    ...
    class DriverRequestListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.textViewRequestNumber.setTypeface(Data.latoRegular(getApplicationContext()));
...
//                        try {
//                            lastGPSLocation.setTime(System.currentTimeMillis()-(2*threeMinuteMillis));
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                        }
