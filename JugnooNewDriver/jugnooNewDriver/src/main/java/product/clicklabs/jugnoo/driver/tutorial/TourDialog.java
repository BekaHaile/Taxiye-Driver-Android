...
public class TourDialog {
    private static final String TAG = TourDialog.class.getSimpleName();
    ...
    private TourDialog init() {
        ...
        try {
            ...
            alertDialog.setContentView(R.layout.dialog_tour);
...
//            });
    ...
    public static class Builder {
        ...
        private TourDialog alertDialog = new TourDialog();
