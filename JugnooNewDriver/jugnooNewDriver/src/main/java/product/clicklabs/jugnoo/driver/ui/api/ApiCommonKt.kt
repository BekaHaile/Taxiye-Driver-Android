    ...
    private  fun  hitApi() {
       ...
       val callback = object : Callback<T> {
        ...
        when (apiName) {
            ...
            ApiName.FETCH_WALLET_BALANCE ->  RestClient.getApiServices().fetchWalletPaymentConfig(params, callback as Callback<WalletModelResponse> )
            ...
            ApiName.OTP_VIA_CALL ->  RestClient.getApiServices().sendOtpViaCall(params, callback as Callback<FeedCommonResponseKotlin> )
