	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			if(type.equalsIgnoreCase("cancel")){
				Intent intent = new Intent(ShareActivity1.this, HomeActivity.class);
...
//				intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
		...
		new ASSL(ShareActivity1.this, relative, 1134, 720, false);
...
//			String hindiMessage = "आमंत्रण बोनस! कस्टमर को अपने "+  + " Jugnoo App डाउनलोड करवांए और पांए "+ getResources().getString(R.string.rupee) + " 30 और कस्टमर को दिलवाए Jugnoo कैश ।";
		...
		buttonShare.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				confirmCustomerNumberPopup(ShareActivity1.this);
			}
		});
			...
			public void onReceive(Context arg0, Intent arg1) {
				switch (getResultCode())
				{
					...
					case SmsManager.RESULT_ERROR_GENERIC_FAILURE:
						DialogPopup.alertPopup(ShareActivity1.this, "", "आपका रेफ़रल कोड कस्टमर " + phoneNumber + " के साथ शेयर नहीं हो पाया है।");
						break;
