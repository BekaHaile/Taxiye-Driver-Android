...
//    @Override
//    public void openChat(String categoryName, String transactionId, String userUniqueId, int supportId, ArrayList<String> pathList, OnFinishedListener onFinishedListener) {
//        try {
//            String channelName = categoryName+" #"+userUniqueId+"_"+supportId;
//            if(!TextUtils.isEmpty(transactionId))
//                channelName = categoryName+" #"+transactionId;
//
////            String channelName = String.format(activity.getString(R.string.hippo_uniqueId_channel_name), categoryName, userUniqueId, supportId);
////            if(!TextUtils.isEmpty(transactionId))
////                channelName = String.format(activity.getString(R.string.hippo_channel_name), categoryName, transactionId);
//
//
//            String message = "";
...
//                onFinishedListener.openChat(transactionId, userUniqueId, channelName, tagsList, msg);
//
//        } catch (Exception e) {
//            e.printStackTrace();
//            if(onFinishedListener != null)
